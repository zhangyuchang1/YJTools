...
#import "ALDRefreshStateHeader.h"

@interface ALDRefreshStateHeader()
{
    /** 显示上一次刷新时间的label */
...
@implementation ALDRefreshStateHeader
#pragma mark - 懒加载
...
- (void)prepare
{
    ...
    // 初始化文字
    [self setTitle:ALDRefreshHeaderIdleText forState:ALDRefreshStateIdle];
    [self setTitle:ALDRefreshHeaderPullingText forState:ALDRefreshStatePulling];
    [self setTitle:ALDRefreshHeaderRefreshingText forState:ALDRefreshStateRefreshing];
}
